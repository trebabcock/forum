<template>
  <div
    class="flex space-x-4 items-center text-slate-50 cursor-pointer rounded-lg"
  >
    <Menu as="div" class="relative inline-block text-left w-full h-full">
      ...
      >
        <MenuItems
          class="absolute right-0 w-56 mt-2 origin-top-right text-slate-50 bg-slate-900 divide-y divide-slate-800 rounded-lg shadow-lg"
        >
          <div class="px-1 py-1">
